...
public class Fordfulkerson {
    ...
    // fordfulkerson
    public static int findSizeOfMinCut(int graph[][], int s, int t) {
        int u, v;
        int V = graph.length;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The size of min cut from "+src+" to "+dst+" is "
                + Fordfulkerson.findSizeOfMinCut(graph, src, dst));
    }
}